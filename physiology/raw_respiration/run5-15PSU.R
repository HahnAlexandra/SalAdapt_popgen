...
resp_15 <- read_excel("2024-07-23A15_Oxygen.xls", skip = 12)
str(resp_15)
...
c2 <- inspect(resp_15, time = 2, oxygen = 4, plot = TRUE)
c3 <- inspect(resp_15, time = 2, oxygen = 5, plot = TRUE)
c4 <- inspect(resp_15, time = 2, oxygen = 6, plot = TRUE)
c5 <- inspect(resp_15, time = 2, oxygen = 7, plot = TRUE)
c6 <- inspect(resp_15, time = 2, oxygen = 8, plot = TRUE) 
c7 <- inspect(resp_15, time = 2, oxygen = 14, plot = TRUE)
c8 <- inspect(resp_15, time = 2, oxygen = 15, plot = TRUE)
c9 <- inspect(resp_15, time = 2, oxygen = 16, plot = TRUE)
c10 <- inspect(resp_15, time = 2, oxygen = 17, plot = TRUE)
c11 <- inspect(resp_15, time = 2, oxygen = 18, plot = TRUE)
c12 <- inspect(resp_15, time = 2, oxygen = 19, plot = TRUE)
c13 <- inspect(resp_15, time = 2, oxygen = 20, plot = TRUE)
c14 <- inspect(resp_15, time = 2, oxygen = 21, plot = TRUE)


#controls look ok

#population
iu1 <- inspect(resp_15, time = 2, oxygen = 9, plot = TRUE) 
iu2 <- inspect(resp_15, time = 2, oxygen = 10, plot = TRUE)  
iu3 <- inspect(resp_15, time = 2, oxygen = 11, plot = TRUE) 
iu4 <- inspect(resp_15, time = 2, oxygen = 12, plot = TRUE) 
iu5 <- inspect(resp_15, time = 2, oxygen = 13, plot = TRUE)  
iu6 <- inspect(resp_15, time = 2, oxygen = 22, plot = TRUE) # 1 animal
iu7 <- inspect(resp_15, time = 2, oxygen = 23, plot = TRUE)  
iu8 <- inspect(resp_15, time = 2, oxygen = 24, plot = TRUE)
iu9 <- inspect(resp_15, time = 2, oxygen = 25, plot = TRUE)  
iu10 <- inspect(resp_15, time = 2, oxygen = 26, plot = TRUE)


#calculate background resp

bg_insp <- inspect(resp_15, time = 2, oxygen = c(3,4,5,6,7,8,14,15,16,17,18,19,20,21))
