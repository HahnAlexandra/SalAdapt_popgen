...
resp_05 <- read_excel("2024-09-25-A5PSU_Oxygen.xls", skip = 12)
str(resp_05)
...
resp_05 <- subset_data(resp_05, from = 11, to = 32, by = "row")
inspect_5 <- inspect(resp_05, time = 2, oxygen = 3:26)

#controls

c1 <- inspect(resp_05, time = 2, oxygen = 4, plot = TRUE)
c2 <- inspect(resp_05, time = 2, oxygen = 8, plot = TRUE)# 
c3 <- inspect(resp_05, time = 2, oxygen = 10, plot = TRUE)
c4 <- inspect(resp_05, time = 2, oxygen = 14, plot = TRUE)
c5 <- inspect(resp_05, time = 2, oxygen = 16, plot = TRUE) 
c6 <- inspect(resp_05, time = 2, oxygen = 20, plot = TRUE) 
c7 <- inspect(resp_05, time = 2, oxygen = 22, plot = TRUE)
...
#populations
bk1 <- inspect(resp_05, time = 2, oxygen = 3, plot = TRUE)  
bk2 <- inspect(resp_05, time = 2, oxygen = 5, plot = TRUE)
bk3 <- inspect(resp_05, time = 2, oxygen = 12, plot = TRUE) 
bk4 <- inspect(resp_05, time = 2, oxygen = 13, plot = TRUE)   
bk5 <- inspect(resp_05, time = 2, oxygen = 15, plot = TRUE)  
bk6 <- inspect(resp_05, time = 2, oxygen = 17, plot = TRUE)
bk7 <- inspect(resp_05, time = 2, oxygen = 24, plot = TRUE)
bk8 <- inspect(resp_05, time = 2, oxygen = 25, plot = TRUE) 

gd1 <- inspect(resp_05, time = 2, oxygen = 6, plot = TRUE)  
gd2 <- inspect(resp_05, time = 2, oxygen = 7, plot = TRUE) 
gd3 <- inspect(resp_05, time = 2, oxygen = 9, plot = TRUE) # already low at start - exclude
gd4 <- inspect(resp_05, time = 2, oxygen = 11, plot = TRUE) # already low at start - exclude
gd5 <- inspect(resp_05, time = 2, oxygen = 18, plot = TRUE) # already low at start - exclude
gd6 <- inspect(resp_05, time = 2, oxygen = 19, plot = TRUE) # already low at start - exclude
gd7 <- inspect(resp_05, time = 2, oxygen = 21, plot = TRUE) # already low at start - exclude
gd8 <- inspect(resp_05, time = 2, oxygen = 23, plot = TRUE)# 1 animal

#check lines in which o2% are lower than 65% - they need to be excluded

#calculate background resp

bg_insp <- inspect(resp_05, time = 2, oxygen = c(4,8,10,14,16,20,22,26))
