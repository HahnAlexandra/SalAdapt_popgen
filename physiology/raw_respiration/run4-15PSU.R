...
resp_15 <- read_excel("2024-07-16A15_Oxygen.xls", skip = 12)
...
resp_15 <- subset_data(resp_15, from = 8, to = 35, by = "row")
inspect_15 <- inspect(resp_15, time = 2, oxygen = 3:26)
...
#populations
wh1 <- inspect(resp_15, time = 2, oxygen = 3, plot = TRUE) 
wh2 <- inspect(resp_15, time = 2, oxygen = 5, plot = TRUE)  
wh3 <- inspect(resp_15, time = 2, oxygen = 12, plot = TRUE) 
wh4 <- inspect(resp_15, time = 2, oxygen = 13, plot = TRUE)  
wh5 <- inspect(resp_15, time = 2, oxygen = 15, plot = TRUE)  
wh6 <- inspect(resp_15, time = 2, oxygen = 17, plot = TRUE)  
wh7 <- inspect(resp_15, time = 2, oxygen = 24, plot = TRUE)  
wh8 <- inspect(resp_15, time = 2, oxygen = 25, plot = TRUE)


sw1 <- inspect(resp_15, time = 2, oxygen = 6, plot = TRUE) 
sw2 <- inspect(resp_15, time = 2, oxygen = 7, plot = TRUE) 
sw3 <- inspect(resp_15, time = 2, oxygen = 9, plot = TRUE) 
sw4 <- inspect(resp_15, time = 2, oxygen = 11, plot = TRUE) 
sw5 <- inspect(resp_15, time = 2, oxygen = 18, plot = TRUE)
sw6 <- inspect(resp_15, time = 2, oxygen = 19, plot = TRUE) 
sw7 <- inspect(resp_15, time = 2, oxygen = 21, plot = TRUE) 
sw8 <- inspect(resp_15, time = 2, oxygen = 23, plot = TRUE)
