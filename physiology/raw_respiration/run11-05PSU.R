...
resp_05 <- read_excel("2024-10-04-A5PSU_Oxygen.xls", skip = 12)
str(resp_05)
...
resp_05 <- subset_data(resp_05, from = 11, to = 34, by = "row")
inspect_5 <- inspect(resp_05, time = 2, oxygen = 3:26)

#controls

c1 <- inspect(resp_05, time = 2, oxygen = 3, plot = TRUE)
c2 <- inspect(resp_05, time = 2, oxygen = 6, plot = TRUE)
c3 <- inspect(resp_05, time = 2, oxygen = 9, plot = TRUE)
c4 <- inspect(resp_05, time = 2, oxygen = 12, plot = TRUE)
c5 <- inspect(resp_05, time = 2, oxygen = 15, plot = TRUE) 
c6 <- inspect(resp_05, time = 2, oxygen = 18, plot = TRUE) 
c7 <- inspect(resp_05, time = 2, oxygen = 21, plot = TRUE)
...
#populations
h1 <- inspect(resp_05, time = 2, oxygen = 4, plot = TRUE)  
h2 <- inspect(resp_05, time = 2, oxygen = 5, plot = TRUE)
h3 <- inspect(resp_05, time = 2, oxygen = 13, plot = TRUE) 
h4 <- inspect(resp_05, time = 2, oxygen = 14, plot = TRUE)   
h5 <- inspect(resp_05, time = 2, oxygen = 16, plot = TRUE)  
h6 <- inspect(resp_05, time = 2, oxygen = 17, plot = TRUE)
h7 <- inspect(resp_05, time = 2, oxygen = 25, plot = TRUE)
h8 <- inspect(resp_05, time = 2, oxygen = 26, plot = TRUE) 

gd1 <- inspect(resp_05, time = 2, oxygen = 7, plot = TRUE)  
gd2 <- inspect(resp_05, time = 2, oxygen = 8, plot = TRUE)
gd3 <- inspect(resp_05, time = 2, oxygen = 10, plot = TRUE) 
gd4 <- inspect(resp_05, time = 2, oxygen = 11, plot = TRUE)   
gd5 <- inspect(resp_05, time = 2, oxygen = 19, plot = TRUE)  
gd6 <- inspect(resp_05, time = 2, oxygen = 20, plot = TRUE)
gd7 <- inspect(resp_05, time = 2, oxygen = 22, plot = TRUE)
gd8 <- inspect(resp_05, time = 2, oxygen = 23, plot = TRUE)
...
a.rategd6 <- adjust_rate(rategd6, bg_rate)
...
finalgd6 <- convert_rate(a.rategd6,         #  rate adjusted for background
                         oxy.unit = "%Oxy",     # oxygen units of the original raw data
                         time.unit = "min",     # time units of the original raw data
                         output.unit = "uL/hour", #use ml/hour instead 
                         S=5,
...
summaries <- list(
  ...
  s14 <- summary(finalgd6),
  s15 <- summary(finalgd7),
  s16 <- summary(finalgd8)
